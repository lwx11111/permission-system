...
@RestController
@Tag(name = "服务")
@RequestMapping("/sysnoticegrouprela")
public class SysNoticeGroupRelaController {
    @Autowired
    private ISysNoticeGroupRelaService service;

    @PostMapping
    @ResponseBody
    @Operation(description = "创建")
    public SimpleResponse save(@RequestBody SysNoticeGroupRela obj){
    ...
    public SimpleResponse update(@PathVariable(name = "id") String id,@RequestBody SysNoticeGroupRela obj){
    ...
    public SimpleResponse selectBy(@RequestBody(required = false) Map<String, String> params) {
        List<SysNoticeGroupRela> sysnoticegrouprelas = service.selectBy(params);
        return new SimpleResponse.SimpleResponseBuilder().success(sysnoticegrouprelas).build();
    }
    ...
    public SimpleResponse selectPage(@RequestBody Map<String, String> params) {
        try {
            IPage<SysNoticeGroupRela> page = service.selectPage(params);
    ...
    public SimpleResponse selpageCustomSqlByWrapper(@RequestBody Map<String, String> params) {
        try {
            IPage<SysNoticeGroupRela> page = service.selpageCustomSqlByWrapper(params);
            return new SimpleResponse.SimpleResponseBuilder().success(page).build();
        } catch (Exception e) {
            e.printStackTrace();
            return new SimpleResponse.SimpleResponseBuilder().failure(e.getMessage()).build();
    ...
    public SimpleResponse selpageCustomSqlByMap(@RequestBody Map<String, String> params) {
        try {
            IPage<SysNoticeGroupRela> page = service.selpageCustomSqlByMap(params);
            return new SimpleResponse.SimpleResponseBuilder().success(page).build();
        } catch (Exception e) {
            e.printStackTrace();
            return new SimpleResponse.SimpleResponseBuilder().failure(e.getMessage()).build();
