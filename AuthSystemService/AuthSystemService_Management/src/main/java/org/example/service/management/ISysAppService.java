...
public interface ISysAppService extends IService<SysApp> {
     ...
     * @return: void
     */
    void saveByParam(SysApp obj,Map<String, String> params);
     ...
     * @return: void
     */
    void updateByParam(SysApp obj,Map<String, String> params);
    /**
     * 根据条件删除
     *
     * @param params
     ...
     * @return: List<SysApp>
     */
     List<SysApp> selectBy(Map<String, String> params);
     ...
     * @return: IPage<SysApp>
    */
    IPage<SysApp> selectPage(Map<String, String> params);
     ...
     * @return: IPage<SysApp>
    */
    IPage<SysApp> selpageCustomSqlByWrapper(Map<String, String> params);
     ...
     * @return: IPage<SysApp>
    */
    IPage<SysApp> selpageCustomSqlByMap(Map<String, String> params);
