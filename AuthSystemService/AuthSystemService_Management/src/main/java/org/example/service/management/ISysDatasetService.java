...
public interface ISysDatasetService extends IService<SysDataset> {
     ...
     * @return: void
     */
    void saveByParam(SysDataset obj,Map<String, String> params);
     ...
     * @return: void
     */
    void updateByParam(SysDataset obj,Map<String, String> params);
    /**
     * 根据条件删除
     *
     * @param params
     ...
     *
     * @param params
     * @return: List<SysDataset>
     */
     List<SysDataset> selectBy(Map<String, String> params);

    /**
     * 分页查询
     *
     * @param params
     * @return: IPage<SysDataset>
    */
    IPage<SysDataset> selectPage(Map<String, String> params);
     ...
     * @return: IPage<SysDataset>
    */
    IPage<SysDataset> selpageCustomSqlByWrapper(Map<String, String> params);
     ...
     * @return: IPage<SysDataset>
    */
    IPage<SysDataset> selpageCustomSqlByMap(Map<String, String> params);
