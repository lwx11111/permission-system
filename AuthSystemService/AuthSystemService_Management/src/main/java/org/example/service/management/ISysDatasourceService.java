...
public interface ISysDatasourceService extends IService<SysDatasource> {
     ...
     * @return: void
     */
    void saveByParam(SysDatasource obj,Map<String, String> params);
     ...
     * @return: void
     */
    void updateByParam(SysDatasource obj,Map<String, String> params);
    /**
     * 根据条件删除
     *
     * @param params
     ...
     */
     List<SysDatasource> selectBy(Map<String, String> params);

    /**
     * 分页查询
     *
     * @param params
     * @return: IPage<SysDatasource>
    */
    IPage<SysDatasource> selectPage(Map<String, String> params);
     ...
     * @return: IPage<SysDatasource>
    */
    IPage<SysDatasource> selpageCustomSqlByWrapper(Map<String, String> params);
     ...
     * @return: IPage<SysDatasource>
    */
    IPage<SysDatasource> selpageCustomSqlByMap(Map<String, String> params);
