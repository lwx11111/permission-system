<template>
    <div>
        ...
        <ModifyPassword :dialog-visible="data.passwordDialogVisible"
                        :id="data.modifyPasswordAccountId"
                        @close="handlePasswordCloseDialog"></ModifyPassword>
    </div>
</template>
<script lang="ts" setup>
    ...
    const toModifyPassword = (scope) => {
        ...
        data.modifyPasswordAccountId = scope.row.accountId;
    }
